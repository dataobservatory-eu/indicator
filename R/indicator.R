...
#' manual revision.
#' @param date_indicator The creation/refreshment date of the indicator. If omitted, calls
#' \code{Sys.Date()}.
...
indicator <- function(x, 
  ...
  if (is.null(date_indicator)) date_indicator <- Sys.Date()
...
print.indicator <- function(x, ... ) {
  ...
  cat(paste0('Source: ', attr(x, "observatory")), " DOI: ", attr(x, "doi"))
...
new_indicator <- function(x, 
  ...
  attr(indicator, "date_indicator") <- date_indicator
